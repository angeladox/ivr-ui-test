package org.motechproject.ivr.ui;
...
/**
 * Wrapper around {#link {@link SettingsFacade} to access ivr-ui-test related
 * properties
 */
@Component
public class IVRUISettings {
    private final Logger logger = LoggerFactory.getLogger(IVRUISettings.class);
    ...
    @Autowired
    public IVRUISettings(SettingsFacade settingsFacade) {
