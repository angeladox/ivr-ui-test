...
import org.motechproject.ivr.ui.support.CallRequestDataKeys;
...
public class PillReminderListener {
    ...
    @Autowired
    public PillReminderListener(IVRService ivrService, MrsEntityFacade mrsEntityFacade, IVRUISettings settings) {
